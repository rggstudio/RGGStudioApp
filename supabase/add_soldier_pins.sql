-- Add PINs to Soldier League teams
-- This script hashes the PINs using bcrypt and inserts them into sl_team_codes

INSERT INTO public.sl_team_codes (team_id, pin_hash, updated_at)
SELECT 
  t.id as team_id,
