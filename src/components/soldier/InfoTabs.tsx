              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="ml-6 list-disc space-y-2">
                    <li>
                      Log in using your <strong>Team Name</strong> and your 4-digit <strong>PIN</strong>
                    </li>
                    <li>View weekly Game of the Week matchups and make your picks</li>
                    <li>
                      Change your pick at any time until the game is <strong>locked by the commissioner</strong>
                    </li>
                ...
                <div>
                  ...
                  <ul className="ml-6 list-disc space-y-2">
                    <li>
                      <strong>+3 points</strong> for a correct Game of the Week pick (awarded automatically)
                    </li>
                ...
                <div>
                  ...
                  <p className="ml-6">
                    View all your past picks organized by week, see the correct results, and track your points earned
                ...
                <ul className="space-y-2">
                  ...
                  <li className="rounded bg-slate-800/50 p-3">
                    ...
                    <p className="mt-1 text-xs text-slate-400">
                      (True DE&apos;s only, coaches are required to send proof. If proof is not sent they will be CAP as a
                      LB)
                    </p>
                  </li>
                  <li className="rounded bg-slate-800/50 p-3">
                    ...
                    <p className="mt-1 text-xs text-slate-400">
                      (CAP 80 - PMV or FMV, and BSH) If any ability is met between PMV or FMV, no additional points will
                      be granted. BSH can independently be earned if below the threshold.
                    </p>
                  </li>
                  <li className="rounded bg-slate-800/50 p-3">
