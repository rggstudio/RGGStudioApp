...
export default function PlayerRequests() {
  ...
  const fetchRequests = async () => {
    ...
    try {
      const url = statusFilter === 'all' 
        ? '/api/powerhouse/admin/player-requests'
        : `/api/powerhouse/admin/player-requests?status=${statusFilter}`
  ...
  const handleApprove = async (requestId: string) => {
    ...
    try {
      const response = await fetch(`/api/powerhouse/admin/player-requests/${requestId}/approve`, {
        method: 'POST',
      })
  ...
  const handleDeny = async () => {
    ...
    try {
      const response = await fetch(`/api/powerhouse/admin/player-requests/${denyModal.id}/deny`, {
        method: 'POST',
        headers: {
