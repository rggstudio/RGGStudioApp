...
import { setTeamSession } from '@/lib/soldier/session'
import { teamLoginSchema } from '@/lib/soldier/validators'
...
export const POST = async (request: Request) => {
  ...
  const { data, error } = await supabase.rpc('sl_authenticate_team', {
